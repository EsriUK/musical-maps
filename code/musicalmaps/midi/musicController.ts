...
export class MusicController{
    ...
    private static _instance:MusicController = new MusicController();
    private midiController:MidiControl.MidiController;
    private _noteArray:string[];
    private _majorScalePattern:number[];
    private _minorScalePattern:number[];
    ...
    public getNoteNumber(noteLetter):any{
