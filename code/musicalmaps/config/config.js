define(["require", "exports"], function (require, exports) {
    ...
    var ConfigManager = (function () {
        ...
        ConfigManager.prototype.getWebmap = function (webmapId) {
            return $.ajax({
                type: "POST",
        ...
        ConfigManager.prototype.getLayerDetails = function (layer) {
            return $.ajax({
                type: "POST",
        ...
        ConfigManager.prototype.getRendererSelection = function (layer) {
            var that = this;
            var dfd = $.Deferred();
        ...
        ConfigManager.prototype.configureLayers = function (webmap) {
            var that = this;
        ...
        ConfigManager.prototype.getMapKey = function (webmap) {
            var that = this;
            var dfd = $.Deferred();
        ...
        ConfigManager.prototype.listen = function () {
            var that = this;
            var dfd = $.Deferred();
            ...
            $('#configJson').on('click', function (evt) {
                ...
                that.dropJSON(document.getElementById("formBackground"), function (data) {
        ...
        ConfigManager.prototype.dropJSON = function (targetEl, callback) {
